...
describe('getElement', () => {
  beforeEach(function () {
    affix(
      '#js-floatl.floatl label#js-label.floatl__label+input#js-input.floatl__input[type="text"]'
    )
  })
  ...
  describe('Initialization', () => {
    ...
    it(`adds %{multilineClass} class if applied to a textarea`, function () {
      affix(
        '#js-multiline-floatl.floatl label#js-label.floatl__label+textarea#js-input.floatl__input'
      )
